...
import { verifyOTP, resendOTP, resendForgotPasswordOTP, clearSuccess, clearResendSuccess } from '../store/authSlice';
...
const OTP = () => {
  ...
  // تحديد نوع العملية من الـ location state
  ...
  }, [success, navigate, isForgotPassword, phone, dispatch]);
  ...
  const handleKeyDown = (index, e) => {
    // الانتقال للـ input السابق عند الضغط على Backspace
  ...
  const handleSubmit = (e) => {
    ...
    if (otpString.length !== 5) {
      alert(getLanguage() === 'ar' ? 'يرجى إدخال الرمز كاملاً' : 'Please enter the complete code');
      return;
    }
  ...
  return (
    <div className="otp-wrapper" dir={isArabic ? 'rtl' : 'ltr'}>
